...
function get_member_status_sel($member_in, $status_val_in, $tbl_in) {
	...
	$dis = "";
	$i = 0;
	$outstr = "<SELECT CLASS='text' STYLE=\"width: 90%; color: {$fgcol}; background-color: {$bgc};\" name='frm_status_id' onChange = 'do_sel_update_mem({$member_in}, this.value)' >";
