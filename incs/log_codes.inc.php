...
$types = array();
	...
	$types[$GLOBALS['LOG_FAILED_SIGN_IN']]					="Failed Sign In";
	...
	$types[$GLOBALS['LOG_MEMBER_STATUS']]					="Member Status Change";
	$types[$GLOBALS['LOG_MEMBER_COMPLETE']]					="Member Updated";
	$types[$GLOBALS['LOG_MEMBER_CHANGE']]					="Member Updated";
	$types[$GLOBALS['LOG_MEMBER_ADD']]						="Member Added";
	$types[$GLOBALS['LOG_MEMBER_TYPE']]						="Member Type Change";
