...
//	if(sessions[previous]) {sessions[previous].disconnect();}
...
<BODY onload="startup()">
<DIV id='outer' style='width: 100%; height: 500px; text-align: center; display: block;'>
	...
	<SPAN id='scanner' class='plain' style='position: relative; right: 150px; width: 100px; display: inline-block; float: right;' onMouseover='do_hover(this.id);' onMouseout='do_plain(this,id);' onClick='resumeScan();'>Scan</SPAN>
	</SPAN>
	<DIV id='column' style='position: relative; left: 8%; width: 80%; height: 100%; text-align: center; border: 1px outset #707070; display: block; padding: 2%;'>
<?php
