...
?>
		...
		function set_expires(val) {
			if(val=="Yes") {
				tpack_add_Form.frm_day_refresh.disabled = false;
				tpack_add_Form.frm_month_refresh.disabled = false;
				tpack_add_Form.frm_year_refresh.disabled = false;
				} else if(val=="Permanent") {
				tpack_add_Form.frm_day_refresh.disabled = true;
				tpack_add_Form.frm_month_refresh.disabled = true;
				tpack_add_Form.frm_year_refresh.disabled = true;
				} else {
				return false;
				}
			}
