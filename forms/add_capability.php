...
?>
				...
				<DIV id='rightcol' style='position: relative; left: 40px; float: left;'>
					...
					<BR />
					<BR />
					<SPAN style='display: inline-block; float: left; vertical-align; text-bottom;'><?php print get_text('Capabilities');?> need to be added to the system first either from "Config" or by clicking</SPAN>
					<SPAN ID='to_capabilities' class = 'plain' style='display: inline-block; float: left; vertical-align; text-bottom;' onMouseOver="do_hover(this.id);" onMouseOut="do_plain(this.id);" onClick = "do_Post('capability_types');">Here</SPAN><BR />
					</DIV>
				</DIV>
			</DIV>	
