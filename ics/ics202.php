...
function set_input_strings () {
	...
	$out_arr['f_0'] = in_text ( 0, 34, " (required)", 32 ) ;
	$out_arr['f_1'] = in_text ( 1, 11 ) ;
	$out_arr['f_2'] = in_text ( 2, 11 ) ;
	$out_arr['f_3'] = in_text ( 3, 5 ) ;
	$out_arr['f_4'] = in_text ( 4, 5 ) ;
	$out_arr['f_5'] = in_area ( 5, 89 , 2 ) ; 		// ( $name, $cols, $rows )
	$out_arr['f_6'] = in_area ( 6, 89 , 2 ) ;
	$out_arr['f_7'] = in_area ( 7, 89 , 2 ) ;
