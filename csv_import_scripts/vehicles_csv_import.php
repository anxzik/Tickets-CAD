...
?>
	...
	<DIV id='topbar' style='position: fixed; top: 0px; left: 0px; margin-left: 5%; font-size: 14px; z-index: 999; width: 90%; background-color: #DEDEDE; border: 2px outset #CECECE;'>
		...
		<BR />
		<BR />			
		<DIV class='tablehead' style='width: 100%; float: right;'><b>Import Vehicles from CSV File</b></DIV>							
	</DIV>	
...
<?php
	...
	for($z = 0; $z < count($the_arr); $z++) {
		$owner = ($_POST['ic_col']['frm_owner'] != '999999') ? get_owner_id($_POST['ic_col']['frm_owner']) : 1;
		$make = ($_POST['ic_col']['frm_make'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_make']] : "Not Imported";
		$model = ($_POST['ic_col']['frm_model'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_model']] : "Not Imported";	
		$regno = ($_POST['ic_col']['frm_regno'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_regno']] : "Not Imported";	
		$type = 1;		
		$seats = ($_POST['ic_col']['frm_seats'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_seats']] : 5;		
		$fueltype = ($_POST['ic_col']['frm_fueltype'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_fueltype']] : "Petrol";		
		$roofrack = ($_POST['ic_col']['frm_roofrack'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_roofrack']] : "No";		
		$towbar = ($_POST['ic_col']['frm_towbar'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_towbar']] : "None";		
		$winch = ($_POST['ic_col']['frm_winch'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_winch']] : "None";	
		$trailer = ($_POST['ic_col']['frm_trailer'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_trailer']] : "No";
		$vin = ($_POST['ic_col']['frm_vin'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_vin']] : "Not Imported";
		$excise = NULL;	
		$test = NULL;	
