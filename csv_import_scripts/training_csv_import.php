...
?>
	...
	<DIV id='topbar' style='position: fixed; top: 0px; left: 0px; margin-left: 5%; font-size: 14px; z-index: 999; width: 90%; background-color: #DEDEDE; border: 2px outset #CECECE;'>
		...
		<BR />
		<BR />			
		<DIV class='tablehead' style='width: 100%; float: right;'><b>Import Training Packages from CSV File</b></DIV>							
	</DIV>	
...
<?php
	...
	for($z = 0; $z < count($the_arr); $z++) {
		$package_name = ($_POST['ic_col']['frm_package_name'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_package_name']] : NULL;
		$description = ($_POST['ic_col']['frm_description'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_description']] : NULL;
		$available = "yes";
		$provider = ($_POST['ic_col']['frm_provider'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_provider']] : NULL;
		$address = ($_POST['ic_col']['frm_address'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_address']] : NULL;
		$name = ($_POST['ic_col']['frm_name'] != '999999') ? $the_arr[$z][$_POST['ic_col']['frm_name']] : NULL;
